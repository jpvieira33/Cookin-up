...
<template>
    <article class="categoria">
      <header class="categoria__cabecalho">
         ...
         <h2 class="paragrago-lg categoria__nome">
            {{ categoria.nome }}
         </h2>
      </header>
      ...
      <ul class="categoria__ingredientes">
           <li v-for="ingrediente in categoria.ingredientes" :key="ingrediente">
             <IngredienteSelecionavel :ingrediente="ingrediente"  @adicionarIngrediente="$emit('adicionarIngrediente', $event)" @removerIngrediente="$emit('removerIngrediente', $event)"/>
         </li>
      </ul>
    </article>
</template>
